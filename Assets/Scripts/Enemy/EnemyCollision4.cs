...
public class EnemyCollision4 : MonoBehaviour {
	...
	void OnTriggerEnter(Collider bull){
			HealthSystem4.health = HealthSystem4.health - 1;
			if(HealthSystem4.health <= 1){
				HealthSystem4.health = 0;
				if (HealthSystem4.health == 0){
