...
public class EnemyCollision7 : MonoBehaviour {
	...
	void OnTriggerEnter(Collider bull){
			HealthSystem7.health = HealthSystem7.health - 1;
			if(HealthSystem7.health <= 1){
				HealthSystem7.health = 0;
				if (HealthSystem7.health == 0){
